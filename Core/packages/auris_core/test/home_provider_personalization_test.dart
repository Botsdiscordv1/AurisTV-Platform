...
class MockPersonalizedRepo implements AurisRepository {
  ...
  @override Future<AnimeDetail?> getAnimeDetail({required String title, int? malId, String? metadataTitle, int? year, int? season, String? kind, String? url, String? type, String? imgSize}) async => null;
