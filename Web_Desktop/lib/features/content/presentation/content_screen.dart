      ...
      Positioned(left: hPadding, right: hPadding, bottom: isUltraCompact ? 10 : 24, child: Row(crossAxisAlignment: CrossAxisAlignment.end, children: [
        Column(crossAxisAlignment: CrossAxisAlignment.start, mainAxisSize: MainAxisSize.min, children: [
          ...
          Row(mainAxisSize: MainAxisSize.min, children: [
            ...
            if (widget.currentSource != null) _ServerSelector(currentSource: widget.currentSource!, sources: widget.sources, onSourceSelected: widget.onSourceSelected, compact: isUltraCompact, unavailableSources: widget.unavailableSources, season: widget.season),
          ]),
        ]),
        if (!isUltraCompact) ...[
