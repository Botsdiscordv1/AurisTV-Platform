                ...
                Expanded(
                  child: Container(
                    decoration: BoxDecoration(
                      ...
                      boxShadow: isSelected ? [BoxShadow(color: Colors.white.withOpacity(0.12), blurRadius: 12, spreadRadius: 1)] : [],
                      border: Border.all(color: isSelected ? Colors.white : Colors.white12, width: isSelected ? 2.0 : 1),
                    ),
                    child: ClipRRect(
